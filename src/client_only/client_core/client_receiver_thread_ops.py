...
def handle_recv_request(prefix, typePrefix, msgContent, client, 
    ...
    if prefix == 0: 
        ...
        handle_ai_suggestion(client, msgContent)
    else: # invalid prefix
        print(f'Received invalid prefix: [{typePrefix}].')
    return

# Receiver thread keeps running until disconnection
...
# After client request for downloading a file on sender thread, it will
# receive the file with the receiver thread (with this function).
